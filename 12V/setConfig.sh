...
if [ "$relais" -eq "2" ]; then
    if [ "$name" = "NULL" ]; then
        sudo sed -i -E "/^\[Relais 2]$/,/^\[/ s/^name = .*/name = N\/A/" /Energiebox/12V/config.ini
    else
...
if [ "$relais" -eq "3" ]; then
    if [ "$name" = "NULL" ]; then
        sudo sed -i -E "/^\[Relais 3]$/,/^\[/ s/^name = .*/name = N\/A/" /Energiebox/12V/config.ini
    else
...
if [ "$relais" -eq "4" ]; then
    if [ "$name" = "NULL" ]; then
        sudo sed -i -E "/^\[Relais 4]$/,/^\[/ s/^name = .*/name = N\/A/" /Energiebox/12V/config.ini
    else
...
if [ "$relais" -eq "6" ]; then
    if [ "$name" = "NULL" ]; then
        sudo sed -i -E "/^\[Relais 6]$/,/^\[/ s/^name = .*/name = N\/A/" /Energiebox/12V/config.ini
    else
...
if [ "$relais" -eq "7" ]; then
    if [ "$name" = "NULL" ]; then
        sudo sed -i -E "/^\[Relais 7]$/,/^\[/ s/^name = .*/name = N\/A/" /Energiebox/12V/config.ini
    else
...
if [ "$relais" -eq "8" ]; then
    if [ "$name" = "NULL" ]; then
        sudo sed -i -E "/^\[Relais 8]$/,/^\[/ s/^name = .*/name = N\/A/" /Energiebox/12V/config.ini
    else
...
if [ "$relais" -eq "9" ]; then
    if [ "$name" = "NULL" ]; then
        sudo sed -i -E "/^\[Relais 9]$/,/^\[/ s/^name = .*/name = N\/A/" /Energiebox/12V/config.ini
    else
...
if [ "$relais" -eq "10" ]; then
    if [ "$name" = "NULL" ]; then
        sudo sed -i -E "/^\[Relais 10]$/,/^\[/ s/^name = .*/name = N\/A/" /Energiebox/12V/config.ini
    else
...
if [ "$relais" -eq "11" ]; then
    if [ "$name" = "NULL" ]; then
        sudo sed -i -E "/^\[Relais 11]$/,/^\[/ s/^name = .*/name = N\/A/" /Energiebox/12V/config.ini
    else
...
if [ "$relais" -eq "12" ]; then
    if [ "$name" = "NULL" ]; then
        sudo sed -i -E "/^\[Relais 12]$/,/^\[/ s/^name = .*/name = N\/A/" /Energiebox/12V/config.ini
    else
...
if [ "$relais" -eq "13" ]; then
    if [ "$name" = "NULL" ]; then
        sudo sed -i -E "/^\[Relais 13]$/,/^\[/ s/^name = .*/name = N\/A/" /Energiebox/12V/config.ini
    else
...
if [ "$relais" -eq "14" ]; then
    if [ "$name" = "NULL" ]; then
        sudo sed -i -E "/^\[Relais 14]$/,/^\[/ s/^name = .*/name = N\/A/" /Energiebox/12V/config.ini
    else
...
if [ "$relais" -eq "15" ]; then
    if [ "$name" = "NULL" ]; then
        sudo sed -i -E "/^\[Relais 15]$/,/^\[/ s/^name = .*/name = N\/A/" /Energiebox/12V/config.ini
    else
...
if [ "$relais" -eq "16" ]; then
    if [ "$name" = "NULL" ]; then
        sudo sed -i -E "/^\[Relais 16]$/,/^\[/ s/^name = .*/name = N\/A/" /Energiebox/12V/config.ini
    else
