                                                            ...
                                                            if (std::cin.fail() || (abwassertank_vorhanden != 0 && abwassertank_vorhanden != 1)) {
                                                                ...
                                                                double literZiel = 0.1;  // gewünschte Literanzahl
                                                                                         ...
                                                                                         H2OFilterManager filter(config);
                                                                                            ...
                                                                                            sprintf(command, "bash /Energiebox/h2o/setIni2.sh %d %d %d %d %d %d %d %f %d %d %f", ventil_pumpe, hex_generator,
                                                                                         filter_gpd, filter_max_menge_filtern, filter_verhaeltnis, filter_clean_time, filter_zeit_100ml, filter_total_liter,
                                                                                         abwassertank_vorhanden,abwassertank_groesse, abwassertank_total_liter  );                          system(command);
                                                                                            //std::cout << "\n" << command << "\n\n";
                                                                                            break;
                                                                                            */
                                                            }
